...
export function formatCountryCode(code: string) {
    const countryValue = codeToCountry.get(code ?? "");
...
export default function CountrySelect(props: ICountrySelectProps) {
    ...
    const countryValue = codeToCountry.get(country ?? "") ?? null;
...
const codeToCountry = new Map<string, CountryType>();
for (const country of countries) {
    codeToCountry.set(country.code, country);
}