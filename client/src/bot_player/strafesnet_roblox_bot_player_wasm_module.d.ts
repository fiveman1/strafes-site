...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_918: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_2048: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_6540: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_919: (a: number, b: number, c: number) => void;
