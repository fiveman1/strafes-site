...
export const event_time: (a: number) => number;
export const event_type_id: (a: number) => number;
...
export const playbackhead_next_event: (a: number, b: number) => number;
export const playbackhead_process_event: (a: number, b: number, c: number) => void;
...
export const __wasm_bindgen_func_elem_1221: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_637: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_1222: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1642: (a: number, b: number, c: number, d: number) => void;
