...
export const playbackhead_set_head_time: (a: number, b: number, c: number) => void;
...
export const __wasm_bindgen_func_elem_1187: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_1611: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1188: (a: number, b: number, c: number) => void;
