...
export const playbackhead_get_game_controls: (a: number, b: number) => number;
export const playbackhead_get_head_time: (a: number, b: number) => number;
export const playbackhead_get_mouse_dir: (a: number, b: number) => number;
...
export const __wasm_bindgen_func_elem_1214: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_630: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_1215: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1635: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_631: (a: number, b: number, c: number) => void;
