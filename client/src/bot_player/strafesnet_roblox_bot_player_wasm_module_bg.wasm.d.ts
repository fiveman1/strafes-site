...
export const playbackhead_new: (a: number, b: number) => void;
export const playbackhead_seek_backward: (a: number, b: number) => void;
export const playbackhead_seek_forward: (a: number, b: number) => void;
export const playbackhead_seek_to: (a: number, b: number, c: number) => void;
...
export const __wasm_bindgen_func_elem_1189: (a: number, b: number) => void;
export const __wasm_bindgen_func_elem_1613: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1190: (a: number, b: number, c: number) => void;
